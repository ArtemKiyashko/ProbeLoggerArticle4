...
Выглядит сложно, но не сложно. Определение "контактных данных" надо будет сделать лишь единожды для своего региона запуска. Поехали по шагам, я буду делать все на нашем примере.
...
![ZC Phone](images/zc_phone.png "Телефон ЗЦ УС ОрВД СПб")
3. Узнаем у них телефон "Стратегической группы". Да, они так себя сами называют. Прям в трубку и говорите: ало, дайте, пожалуйста, телефон стратегической группы.

По контактам это все. Все что у вас должно быть на выходе - телефон этой самой стратегической группы. Переходим к полетному плану.
...
Просто напишите им на [почту](mailto:sppi@matfmc.ru) свой логин и желаюмую роль в системе и они все сделают очень быстро (мне ответили через час, что все готово). Наша желаемая роль - **Оператор Шара-Зонда**. Остальные роли можете посмотреть там же при регистрации - [https://new.ivprf.ru/](https://new.ivprf.ru/)
...
У оператора шара зонда не такую уж и большой выбор типов соощений для составления полетных планов. Это сильно облегчает задачу. Со структурой и вспомогательными функциями сайта я предлагаю ознакомиться самостоятельно, а мы прямо сейчас составим новый план полета.

Идем в раздел **"Воздушные суда"** и нажимаем "Добавить ВС". Это не обязательно, но это слегка автоматизирует заполнения плана вдальнейшем. Нас интересует тип судна - шар-зонд:

![ivprf_1](images/ivprf_1.png "Создание ВС")

**Название** - любое. Это исключительно для вас.

**Опознавательный индекс** - шары-зонды не подлежат регистрации, так что никакого индекса у них нет. В данном случае применяется стандартная заглушка - буквы "Z". Наш (и ваш, если у вас шар-зонд) опознавательный индек5с - **ZZZZZ**
...
Все, больше тут нечего указывать, сохраняем и идем дальше, в **"Планы ИВП"** (ИВП - Использование Воздушного Пространства). Тут нам, операторам шара-зонда, доступен только один тип сообщения - **SHR**:
...
**Скороподъемность** и **Максимальная высота подъема** - также, как и при создании ВС

Теперь **Прочая информация**. Для нее не создали (возможно *пока*) отдельных полей на форме, так что тут все указывается через специальные коды.
...
Напоминаю, что подать план можно **не ранее чем за 5 дней до запуска**. Если это так - жмите "Отправить план" и выбирайте свой зональный центр. В нашем случае это - ЗЦ ЕС ОрВД Санкт-Петербург.
...
то можно выдохнуть и пару дней *ничего не делать*. Теперь вам надо только **за 3 дня до запуска** позвонить стратегической группе своего ЗЦ (ее телефон мы узнавали в начале) и уточнить у них - все ли они получили и все ли хорошо. Бывает так, что не все хорошо. Система у них новая и работает не идеально. Бывало, что они теряли уже принятые в системе планы. Так что этот шаг **крайне не советую** пропускать.

Далее, по протоколу, надо звонить им же еще за сутки и потом за час до запуска. Но, иногда они говорят: "ладно, за сутки не звоните, просто за час/10 минут до запуска позвоните". А потом сами звонят и спрашивают: "все в силе?" ¯\\_(ツ)_/¯ Так или иначе, дальше по звонкам они вас уже скоординируют. Вам остается только выполнять их указания.

Когда настал час "Ч" (за час/минуту до запуска), у вас уже все надуто и включено - звоните снова стратегической группе и докладываете: "запуск по СХР [там-то там-то] разрешаете?". Ваша задача в этот момент - услышать ключевые слова в ответ: "запуск по СХР **разрешаю**". Поздравляю! Вы совершили зарегестрированный запуск шара-зонда!

Диспечер группы еще попросит вас связаться с ним, когда шар приземлится. Не забудьте сделать это! Это будет последний доклад в контексте текущего запуска. Всё. На этом запуск завершен!