...
>В качестве альтернативы - можете выслать сформированный план на электронную почту группы ТПП (и дальше вести переписку по почте). Почта для СПб ЗЦ: **spbzc@sz.gkovd.ru**
...
Когда настал час "Ч" (за час/минуту до запуска), у вас уже всё надуто и включено - звоните снова группе ТПП и спрашивайте: "запуск по СХР [там-то там-то] разрешаете?". Ваша задача в этот момент - услышать ключевые слова в ответ: "запуск по СХР **разрешаю**". Поздравляю! Вы совершили зарегистрированный запуск шара-зонда!
