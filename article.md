...
![Vostok Registartion](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/collage_alt.png "Самодельный стратостат. Полётный план и ОрВД")
...
![Flight Plan Process](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/flight_plan_process.png "Общий алгоритм действий")
...
![ZC Phone](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/zc_phone.png "Телефон ЗЦ ЕС ОрВД СПб")
...
![Reg Fail](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/reg_fail.jpg "Проблемы с регистрацией")
...
![ivprf_1](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/ivprf_1.png "Создание ВС")
...
![ivprf_2](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/ivprf_2.png "Типы сообщений")
...
![ivprf_3](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/ivprf_3.png "Форма SHR")
...
![Coordinates](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/coordinates.png "Формат координат")

> В интернетах я встречал мнение, что для шара-зонда необходимо указывать сектор/конус/еще_что-то_странное координат направления полёта - это, разумеется, не так. Никаких секторов/маршрутов и т.п. от вас не требуется - этим занимается группа ТПП! Именно они запрашивают погоду для предоставленного района запуска и времени. И берут на себя ответственность оповещения воздушного движения о наличии шара-зонда в радиусе и по предполагаемому маршруту движения. От вас требуется только **точка запуска**.
>
...
![ivprf_4](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/ivprf_4.png "Сформировать план")
...
![ivprf_5](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/ivprf_5.png "План отправлен")

Полдела сделано. ЗЦ должен его получить и присвоить ему некий SID и статус. Сначала он будет "На обработке":

![ivprf_6](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/ivprf_6.png "План на обработке")

Затем одно из двух:

![ivprf_7](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/ivprf_7.png "План принят")

Или:

![ivprf_10](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/ivprf_10.png "План отвергнут")

Да, я не просто так уделил особое внимание к полю `DEP/` :)

Что ж, если вы видите у себя картинку, похожую на эту:

![ivprf_9](https://github.com/ArtemKiyashko/ProbeLoggerArticle4/raw/master/images/ivprf_9.png "План принят")
...
[Автор проекта](https://vk.com/sstulekov)
